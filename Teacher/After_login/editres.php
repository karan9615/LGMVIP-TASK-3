...
if(isset($_POST["submit"])){
  $sql = "UPDATE `srms`.`result` SET `sub-1`='$r_s1',`mark-1`='$r_m1',`sub-2`='$r_s2',`mark-2`='$r_m2',`sub-3`='$r_s3',`mark-3`='$r_m3',`sub-4`='$r_s4',`mark-4`='$r_m4',`sub-5`='$r_s5',`mark-5`='$r_m5' WHERE `name`='$n' AND `class`='$c' AND `roll_no`='$r' AND `section`='$s'";
...
<div class="container p-5" style="color: white;">
  <main>
      <div class="col-md-7 col-lg-8 bg-dark p-3" style="width: 100%;">
        <h2 class="mb-3 text-center">Update Marks</h2><hr style="padding: .5%;color: yellow; margin-bottom: 5%;">
  ...
  <select class="form-control" id="sub-1" name="sub-5">
          ...
          <hr class="my-4">
          <button class="w-100 btn btn-primary btn-lg" name="submit" type="submit">Update</button>
        </form>
      </div>
  </main>
</div>
