...
if (!$conn) {
 ...
 $n = isset($_GET["na"])?$_GET["na"]:'';
 $c = isset($_GET["ca"])?$_GET["ca"]:'';
 $r = isset($_GET["ra"])?$_GET["ra"]:'';
 $s = isset($_GET["sa"])?$_GET["sa"]:'';
 ...
 if(isset($_POST["submit"])){
   $sql = "UPDATE `srms`.`student` SET `name`='$stu_name',`dob`='$stu_dob',`gender`='$stu_gender',`father's name`='$stu_father',`mother's name`='$stu_mother',`address`='$stu_address',`roll_no`='$stu_roll',`class`='$stu_class',`section`='$stu_section' WHERE `name`='$n' AND `class`='$c' AND `roll_no`='$r' AND `section`='$s';";
...
<div class="container p-5" style="font-family: 'Andika', sans-serif;color: white;">
  <main>
      <div class="col-md-7 col-lg-8 bg-dark p-5" style="width: 100%;">
        <h2 class="mb-3 text-center">Update student details</h2><hr style="color: orange;margin-bottom: 7%;padding: .5%;">
          ...
          <div class="row g-3">
           ...
           <div class="col-sm-6 pt-3">
            ...
            <div class="col-md-4 pt-3">
              ...
              <div class="col-md-4 pt-3">
              <label for="country" class="form-label">Section</label>
