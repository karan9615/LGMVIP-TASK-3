...
include 'index.php';
    ...
    $gender = isset($_POST["gender"])?$_POST["gender"]:'';
     ...
     $sql = "INSERT INTO `srms`.`teacher`(`name`, `id`, `pwd`, `gender`, `father's name`, `mother's name`) 
     VALUES ('$name','$id','$pwd','$gender','father','$mother')";
...
<div class="container p-5" style="color: white;">
  <main>
      <div class="col-md-7 col-lg-8 bg-dark p-5" style="width: 100%;">
        <h2 class="mb-3 text-center">Add Admin</h2><hr style="padding: .5%; color: pink;">
        <form action="addNew.php" method="POST">
          <div class="row g-3">
            <div class="col-sm-10">
              <label for="Stu_Name" class="form-label">Name</label>
              <input type="text" class="form-control" id="StuName" placeholder="Enter name" name="name" required>
            
              <div class="col-md-12 pt-3">
              <label for="Father's name" class="form-label">Father's name</label>
              <input type="text" class="form-control" id="parents" placeholder="Enter Father's name" name="father" required>
            </div>
           ...
           <div class="col-sm-12 pt-3">
            <input type="radio" name="gender" value="male" class="mx-2">male</input>
            <input type="radio" name="gender" value="female" class="mx-2" >female</input>
           </div>

           
            <div class="col-md-12 pt-3">
              <label for="zip" class="form-label">ID</label>
              <input type="text" class="form-control"  id="id" placeholder="Enter unique id " name="id" required>
            </div>
          </div>
