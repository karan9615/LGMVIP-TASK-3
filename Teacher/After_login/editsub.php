...
$sql = "UPDATE `srms`.`subject` SET `name`='$name',`code`='$code' WHERE `name`='$na' AND `code`='$su'";
...
<h1>Update Subject</h1><hr style="margin-right: 40%;margin-left: 20%;padding: .4%;color: green;margin-bottom: 5%;">
 
 <form action="editsub.php" method="POST" style="width: 80%;" class="p-5 text-light bg-dark form-control">
 <div class='col-md-12'>
